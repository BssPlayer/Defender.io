...
function gameUpdate()
{
    ...
    document.getElementById("swarm1count").textContent = player.swarm1count + ' (' + player.swarm1count % 10 + ')';
    document.getElementById("swarm2count").textContent = player.swarm2count + ' (' + player.swarm2count % 10 + ')';
